...
$users_no = mysqli_fetch_assoc($r)['count'];

$query = "select count(comment_id) as count from comments";
$r = mysqli_query($conn,$query);
$commets_no = mysqli_fetch_assoc($r)['count'];                       //ولا حول ولاقوة إلا بالله 

$query = "select count(post_id) as count from posts";
$r = mysqli_query($conn,$query);
$posts_no = mysqli_fetch_assoc($r)['count'];

$query = "select count(cat_id) as count from categories";
$r = mysqli_query($conn,$query);
$cats_no = mysqli_fetch_assoc($r)['count'];
